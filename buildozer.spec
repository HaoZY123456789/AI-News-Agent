...
source.include_exts = py,png,jpg,kv,atlas,ini,db

# (str) Entry point to use for creating the apk, leave empty to use main.py
...
requirements = python3,kivy,kivymd,requests,beautifulsoup4,feedparser,python-dateutil,lxml,schedule,sqlite3
...
# This property allows to tag placeholders of the form ${name} with the given
# values. Only ${name} placeholders are supported, not the ${name:default} ones.
...
# android.library_references = @jar/my-android-jar.jar,reference/path/to/library_project
...
# use that parameter to set custom Java class for PythonService
...
# (list) python-for-android whitelist of recipes to compile, empty means all recipes are valid
#p4a.whitelist =
...
# 1) android.add_assets = file1.txt,image.png,my_dir
# 2) android.add_assets.1 = path/to/file1.txt
# 2) android.add_assets.2 = path/to/file2.png
# 2) android.add_assets.3 = path/to/my_dir
#android.add_assets =
...
# android.logcat_print_all = False
